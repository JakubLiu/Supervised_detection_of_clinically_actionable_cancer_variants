...
minimum_shannon_entropy <- as.numeric(args[18])
query_pattern <- as.character(args[19])
query_count <- as.numeric(args[20])



output_context_warning_file <- as.character(args[21])
